...
with open("/home/aftab/Desktop/MLOps/task/Code/" + file, 'r') as reader:
     for line in reader:
            sk = "sklearn"
            kr = "keras"
            if sk in line:
...
sudo docker run -dit -v /home/aftab/Desktop/MLOps/Dataset/cnn_dataset/:/Dataset/ --name mlos {} bash"""
